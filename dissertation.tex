...
And this is done by the implementation of coprocessors in MIPS.
...
%I-Type instruction is an instruction which operate with an immediate value and a register value. The immediate value cannot be longer than 16 bits.

Several different Immediate (~\textit{I-Type}) instructions formats are available.

Let's see the formats for this Type in Table ~\ref{tbl:I-Type_instruction_format}.
