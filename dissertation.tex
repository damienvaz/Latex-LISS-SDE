...
without exiting the editing environment.
    ...
    No entanto, o principal objetivo deste trabalho de mestrado é na implementação de um ambiente de desenvolvimento integrado (IDE) apoiado por um editor LISS  específico que impulsiona a criação de qualquer programa fonte livre de erros sintáticos.
    
    Usando a gramática livre de contexto LISS, é possível criar um Editor Dirigido à Sintaxe (SDE) para fornecer a ajuda típica de um editor estruturado que controla a escrita de um programa de origem de acordo com a sintaxe de linguagem como definido pela gramática subjacente. Depois de sintetizar o texto fonte correto, é possível compilar e executá-lo sem sair do ambiente de edição.
