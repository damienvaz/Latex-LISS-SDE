...
%\newpage
\section{Lexical and syntatic analysis}
...
Basically, this data structure is divided into two ~\textit{TreeMap} (those ~\textit{TreeMap} can be seen in Figure ~\ref{fig:error_table_structure}, blue and yellow) and a list (~\textit{ArrayList} data structure) of some error messages.
...
In this case, the first ~\textit{TreeMap} is concerned for ordering the line number of the error message (blue tree in Figure ~\ref{fig:error_table_structure}).

Then when the line number is added and ordered, we add some information linked to the line number and this is the column number of the line (yellow tree in Figure ~\ref{fig:error_table_structure}).
...
9                          & \begin{tabular}[c]{@{}l@{}}Function \textless name\_of\_the\_function \textgreater return type must be\\ 'integer' $||$ 'boolean'.\end{tabular}                                                                                                                                                                                                                                         \\ \hline
10                         & Function \textless name\_of\_the\_function \textgreater has an infinite cycle.                                                                                                                                                                                                                                                                                                          \\ \hline
11                         & \begin{tabular}[c]{@{}l@{}}Expression \textless expression\_string \textgreater has type \textless left\_type\_found \textgreater \\ \textless operator\_string \textgreater \textless right\_type\_found \textgreater, required type \\ \textless left\_type\_required \textgreater \textless operator\_string \textgreater \textless right\_type\_required \textgreater.\end{tabular} \\ \hline
12                         & \begin{tabular}[c]{@{}l@{}}Expression \textless name\_of\_the\_array\_variable \textgreater has dimension \\ \textless dimension\_found \textgreater, when it should be equal to \\ \textless dimension\_required \textgreater.\end{tabular}                                                                                                                                            \\ \hline
13                         & 'stepUp' or 'stepDown' expression, not valid with "inArray" operation.                                                                                                                                                                                                                                                                                                                      \\ \hline
14                         & 'satisfying' expression, not valid with "inArray" operation.                                                                                                                                                                                                                                                                                                                              \\ \hline
15                         & Function \textless name\_of\_the\_function \textgreater does not exist.                                                                                                                                                                                                                                                                                                                 \\ \hline
16                         & \begin{tabular}[c]{@{}l@{}}Expression \textless name\_of\_the\_array\_variable \textgreater doesn't have the same \\ limits or dimensions.\end{tabular}                                                                                                                                                                                                                                 \\ \hline
\end{tabular}
\end{table}
...
\item Message for functions regarding to the return type which is different beside that an 'integer' or a 'boolean'.
\item Message for functions that can be called recursively also known as infinite cycle.
...
\begin{lstlisting}[label={lst:variable_declaration_error},caption={Variable declaration error in LISS}]
  variable_declaration : vars '->' type ';'
\end{lstlisting}
...
\begin{lstlisting}[label={lst:vars_error_message},caption={Vars error in LISS}]
  vars : v1 (',' v2)*
\end{lstlisting}
