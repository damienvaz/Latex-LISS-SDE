...
Let's see how they are created in a function structure in Listing ~\ref{lst:variable_declarations_greater_than_0}.
...
As we can see in Listing ~\ref{lst:variable_declarations_greater_than_0}, they are created in the same way as if it was with a level scope equals to 0. The only thing that is different is that
