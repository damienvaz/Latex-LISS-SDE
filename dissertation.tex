...
% Title
\titleA{Implementing an Integrated Syntax Directed Editor}
...
So we implemented a system which takes the information of the position of the array regarding to the value that was declared in the array.
...
%Variables ~\textit{array2}, ~\textit{array3} and ~\textit{array4} have values declared for some positions and we need to calculate if the dimension of the array is greater than 1.
