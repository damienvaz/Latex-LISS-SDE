...
And regarding to the data structure created, Figure ~\ref{fig:error_table_structure_example} shows an example of how the error messages are being handled relatively to Listing ~\ref{lst:error_table_liss_java_example}.

\begin{figure}[h!]
  \centering
    \includegraphics[width=0.7\textwidth]{img/error_message_example_treemap.png}
    \caption{ErrorTable structure with some example of Listing ~\ref{lst:error_table_liss_java_example}}
