...
Notice that the difference between a less and a greater instruction is only in the use of the registers and that the mechanism for generating the code is the same as talked previously. First, load the code generated relatively to the left part of the operator; second, load the code generated for the right part of the operator and third, add the operator instruction.
