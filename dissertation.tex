...
In Listing ~\ref{lst:term_error_message} is specified the syntax to expand a ~\textit{term} non-terminal in LISS.
...
A particular case of this statement is the use of 'for-each' interval.
...
Listing ~\ref{lst:interval_error_message} is specified how to expand the ~\textit{interval} non-terminal in the context of the ~\textit{for\_stat} in LISS.
...
The ~\textit{type\_interval} non-terminal of the ~\textit{interval} rule in LISS (Listing ~\ref{lst:interval_error_message}) tells us which kind of operation can be a 'for-loop' in LISS.
...
Listing ~\ref{lst:satisfy_error_message} is shown the syntax to define a condition ~\textit{satisfy} in the context of the ~\textit{for\_stat} in LISS.
