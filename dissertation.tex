...
\subsection{Compiler register strategy}
...
By using this strategy, we won't have an overflow of registers. Take care that some instructions used, apply that strategy but might be different due to the complexity.
