...
So, firstly, we need to generate the rules relatively to the LISS language and by this way we need to interact with the view number 1 from Figure ~\ref{fig:LISS-SDE_structure}.
