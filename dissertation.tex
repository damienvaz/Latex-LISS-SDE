...
The variable ~\textbf{data} refers to the value represented for that node, the variables ~\textbf{left} and ~\textbf{right} refers to a node who might be to the left or right side of the node. This is how the Node Class is encapsulated in the project.

Now, the Set class is a class where it saves the information of the tree structure and the free variable of the set.
...
%falar de que maneira se pode criar os sets
